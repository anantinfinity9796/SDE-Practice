...
def get_hc_player_2_moves():
    move = random.randint(0,3)
    return list(rule_dict.keys())[move]

def main():

    print("Do you want to play with a computer or a human")
    print("HH for human-human OR HC for human-computer")
    get_game_mode = input("Game-mode input : ")
